...
* **Size:** X rows × X columns *(lo agrego si querés)*
* **Source:** Kaggle / Public Record *(decime cuál es y lo completo)*
* **Target Variable:** Injury severity (binary or multiclass)
* **Type of Data:** Environmental, temporal, infrastructural, crash mechanics, human factors
